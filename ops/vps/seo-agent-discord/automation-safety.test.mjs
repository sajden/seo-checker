...
test('article review cards use a dedicated Discord channel and explain search intent', () => {
  ...
  assert.match(workerSource, /Andra mätta alternativ:/)
  ...
  assert.match(workerSource, /sebcastwall\.se\/assets\/owner\/hem-it-computer-hero\.png/)
  assert.match(workerSource, /sebcastwall\.se\/assets\/owner\/m365-hardvara-hero\.png/)
