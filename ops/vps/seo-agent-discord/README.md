...
```bash
rsync -av ops/vps/seo-agent-discord/worker.mjs ops/vps/seo-agent-discord/codex-runner.mjs ops/vps/seo-agent-discord/review-promoter.mjs ops/vps/seo-agent-discord/repo-health-check.mjs ops/vps/seo-agent-discord/workload-capacity.mjs ops/vps/seo-agent-discord/json-state-merge.mjs ops/vps/seo-agent-discord/workspace-identity.mjs ops/vps/seo-agent-discord/review-capacity-policy.mjs ops/vps/seo-agent-discord/codex-rewrite-policy.mjs ops/vps/seo-agent-discord/live-page-signal-policy.mjs ops/vps/seo-agent-discord/gsc-url-inspection-api.mjs ops/vps/seo-agent-discord/gsc-firefox-ui-tool.mjs ops/vps/seo-agent-discord/agent-brain.mjs ops/vps/seo-agent-discord/AGENTS.md ops/vps/seo-agent-discord/MEMORY.md ops/vps/seo-agent-discord/README.md deploy@178.104.240.46:/opt/ai-dashboard/apps/seo-agent-discord/
...
- `seoExperiments`: completed SEO changes with a pre-change GSC baseline plus 14/30-day page/query measurements.
- `experimentOutcomes`: quantitative GSC deltas and conservative outcome/confidence classifications used by later scouts.
