...
- run at most two autonomous code commits per workspace per day by default; analyze more, but wait for fresh evidence or explicit operator direction before stacking extra same-day SEO edits,
