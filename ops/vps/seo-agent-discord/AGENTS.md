...
- sebcastwall.se has two approved commercial tracks. Business: AI reviews, AI education, AI agents, AI automation, web development, Flutter/mobile apps, internal tools, digital marketing, Microsoft 365 (including Teams, SharePoint, Planner and Power Automate) and the approved B2B security/camera offer at `/tjanster/sakerhet-kameraovervakning`, focused on Reolink, PoE cameras, NVR, videodoorbells and technical installation for smaller companies. Consumer: local Hem-IT in Bromma/Stockholm with canonical tracks `/tjanster/hem-it/wifi-natverk`, `/tjanster/hem-it/dator-mac`, `/tjanster/hem-it/skrivare-utrustning`, `/tjanster/hem-it/kameror-smart-sakerhet`, `/tjanster/hem-it/konton-bankid-backup` and `/tjanster/hem-it/smart-hem-tv`. Integrations are supporting work rather than the primary position. Treat B2B Wi-Fi and network infrastructure as the remaining strategic expansion candidate; do not invent B2B service claims or create pages autonomously. Do not claim camera/security work is RUT-covered; the Hem-IT page explicitly separates those exceptions.
