...
- sebcastwall.se has two approved commercial tracks. Business: AI reviews, AI education, AI agents, AI automation, web development, Flutter/mobile apps, internal tools, digital marketing and Microsoft 365, including Teams, SharePoint, Planner and Power Automate. Consumer: local Hem-IT in Bromma/Stockholm with canonical tracks `/tjanster/hem-it/wifi-natverk`, `/tjanster/hem-it/dator-mac`, `/tjanster/hem-it/skrivare-utrustning`, `/tjanster/hem-it/kameror-smart-sakerhet`, `/tjanster/hem-it/konton-bankid-backup` and `/tjanster/hem-it/smart-hem-tv`. Integrations are supporting work rather than the primary position. Treat B2B Wi-Fi, camera and security as strategic expansion candidates until the operator confirms the exact offer and target page; do not invent B2B service claims or create pages autonomously. Do not claim camera/security work is RUT-covered; the Hem-IT page explicitly separates those exceptions.
